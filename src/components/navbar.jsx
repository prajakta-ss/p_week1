...
function Navbar() {
 /*  const [theme, setTheme] = useState(localStorage.getItem("theme") ?localStorage.getItem("theme") : "light");
  ...
  return (
    <div className= {`max-w-2x1 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
      sticky ? "sticky-navbar shadow-md bg-base-200  dark:bg-slate-900 dark:text-white duration-300 transition-all ease-in-out" : ""
    }`} >

    <div className=" bg-black text-white navbar">
  ...
  <div className="">
    <a className=" text-white px-3 py-2  hover:bg-slate-800 duration-300 cursor-pointer" 
